...
<body>
	<div id="wrapper">
        ...
        <div id="containerHolder">           
                ...
                <div id="main">
                	<form enctype="multipart/form-data" action="./test2.php" class="jNice" method="post" onsubmit="return check()">
					<h3>发送信息</h3>
                    	<fieldset>
                        	...
                        	<p><label>输入目标联系人:</label><input type="text" class="text-long" name="subject" id="subject"/></p>
                        	<p><label>附件</label><input type="file" name="attachfile"></p>
                           <input name="sub" type="submit" value="发送消息" />
                           <input name="sub" type="submit"  value="" onclick="window.location.href='./test2.php'"/></a>
                        </fieldset>
                    </form>
                </div>
                <!-- // #main -->
